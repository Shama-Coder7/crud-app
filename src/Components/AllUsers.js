...
import { getUsers, deleteUser , addUser, editUser} from './Service/api';
                ...
                {users.map((user) => (
                    <TableRow className={classes.row} key={user.id}>
                        ...
                        <TableCell>
                            ...
                            <Button color="primary" variant="" style={{marginRight:10}} component={Link} to={`/user/${user.id}`}>View</Button>
